  ...
  return (
    <div className="bg-white p-8 rounded-xl shadow-lg animate-fade-in">
      <div className="flex items-center mb-6">
        ...
        <h2 className="text-2xl font-bold text-gray-800">Manage Lectures for {selectedCourse}</h2>
      </div>
      ...
      <div>
        <h3 className="text-lg font-semibold text-gray-800 mb-4">Available Lectures</h3>
        {loading ? (
