      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {buttons.map(({ label, view, icon: Icon }) => (
          <button
            ...
            className="bg-indigo-600 text-white p-6 rounded-lg hover:bg-indigo-700 transition duration-300 flex flex-col items-center justify-center transform hover:scale-105"
          >
